    ...
    render() {
        return (
            <React.Fragment>
                ...
                <Button body className="text-center"  type="button"   onClick = {() => this.props.history.push("/medicationlist")}>Add Medication</Button>
                <Button body className="text-right" onClick={this.props.logout}>Logout</Button>
