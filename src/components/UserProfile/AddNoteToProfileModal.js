    ...
    return (
      ...
      <Button color="danger" onClick={this.toggle}>View Notes</Button>
      {
        <Modal isOpen={this.state.modal}
          ...
          <CardBody  className="text-center" body inverse style={{ backgroundColor: "#93E9BE",          borderColor: "#93E9BE" }}>
          ...
          <h4>{this.props.medication.medication.class}</h4>
              ...
              <AddNoteModal {...this.props} />
                ...
                <div>
                {
                  this.props.notes.filter(note => note.medicationId === this.props.medication.medicationId)
                  .map( note =>(
                  <React.Fragment>
              ...
              style={{ backgroundColor: "#FFF4EF", borderColor: "#FFF4EF" }}>
                ...
                <div className="editDeleteButtons" >
                   <NoteEditFormModal toggle={this.toggle} editNewNote={this.props.editNewNote} notes={this.props.notes} note={note} {...this.props} /> 
                   <Button color="danger" size="" onClick={() =>this.props.deleteNoteFromProfile(note.id)}>
                    Delete
                  </Button>
                  </div>
                  </div>
